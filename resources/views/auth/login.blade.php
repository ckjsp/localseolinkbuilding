    ...
    <div class="authentication-inner row">
        ...
        <div class="d-none d-lg-flex col-lg-7 p-0">
            <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                <img src="{{ asset_url('img/illustrations/auth-login-illustration.png') }}" alt="auth-login-cover"
            ...
            <div class="w-px-400 mx-auto">
                ...
                <div class="app-brand mb-4">
                    <a href="{{ url('/') }}" class="app-brand-link gap-2">
                        <img src="{{ asset_url('img/header-logo.png') }}" data-app-light-img="img/logo.svg"
                ...
                <form class="mb-3" method="POST" action="{{ route('login') }}" id="user-login-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                            name="email" value="{{ old('email') }}" required placeholder="Enter your email or username"
