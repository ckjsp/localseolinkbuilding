...
<section class="section-py first-section-pt">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <h5 class="mb-2 pb-1  fw-bold">Order Processing
            ...
            <div class="col-lg-8">
                <h5 class="mb-2 pb-1  fw-bold">Delivery Timeframes
                </h5>
                <hr class="my-lg-4" />
                <p class="pt-lg-2">
            ...
            <div class="col-lg-8">
                <h5 class="mb-2 pb-1  fw-bold">Shipping Costs and Fees
            ...
            <div class="col-lg-8">
                <h5 class="mb-2 pb-1  fw-bold">Monitoring Your Order
            ...
            <div class="col-lg-8">
                <h5 class="mb-2 pb-1  fw-bold">Order Changes and Cancellations
            ...
            <div class="col-lg-8">
                <h5 class="mb-2 pb-1  fw-bold">Customer Support
