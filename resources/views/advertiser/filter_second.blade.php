        ...
        <li class="menu-item py-2">
            <div class="px-3">
                ...
                <div class="row rounded py-2 ms-1">
                    <div class="col-md-12">
                        <div class="form-check">
                            <input class="form-check-input rounded-circle inputPrice1 price_filter" type="checkbox" name="price[]" id="inputPrice1" value="0-100">
                            <label class="form-check-label" for="inputPrice1">Under $100</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check">
                            <input class="form-check-input rounded-circle inputPrice2 price_filter" type="checkbox" name="price[]" id="inputPrice2" value="100-500">
                            <label class="form-check-label" for="inputPrice2">$100 to $500</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check">
                            <input class="form-check-input rounded-circle inputPrice3 price_filter" type="checkbox" name="price[]" id="inputPrice3" value="500-1000">
                            <label class="form-check-label" for="inputPrice3">$500 to $1000</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check">
                            <input class="form-check-input rounded-circle inputPrice4 price_filter" type="checkbox" name="price[]" id="inputPrice4" value="1000-1500">
                            <label class="form-check-label" for="inputPrice4">$1000 to $1500</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check">
                            <input class="form-check-input rounded-circle inputPrice5 price_filter" type="checkbox" name="price[]" id="inputPrice5" value="1500-2000">
                            <label class="form-check-label" for="inputPrice5">$1500 to $2000</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check">
                            <input class="form-check-input rounded-circle inputPrice6 price_filter" type="checkbox" name="price[]" id="inputPrice6" value="2000-3000">
                            <label class="form-check-label" for="inputPrice6">$2000 to $3000</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-check">
                            <input class="form-check-input rounded-circle inputPrice7 price_filter" type="checkbox" name="price[]" id="inputPrice7" value="3001-99999999">
