                ...
                <form method="POST" action="{{ route('advertiser.projects.store') }}" class="needs-validation"
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="select2-primary">
                            <select id="projectCategories" name="projectCategories[]"  class="select2 form-select select2-hidden-accessible" multiple="" data-select2-id="select2Multiple" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="col-md-6 mb-4">
                        <label for="projectForbiddenCategories" class="form-label">Select the forbidden categories you accept</label>
                        <div class="select2-primary">
                            <select id="projectForbiddenCategories" name="projectForbiddenCategories[]"  class="select2 form-select select2-hidden-accessible BHARGAV" multiple="" data-select2-id="select2Multiple" tabindex="-1" aria-hidden="true">
