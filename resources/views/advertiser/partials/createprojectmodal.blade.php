                ...
                <form method="POST" action="{{ route('advertiser.projects.store') }}" class="needs-validation"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="project_url" id="project_url" class="form-control" required
                            value="" placeholder="Enter Project URLa">
                    </div>
                    <div class="form-group mb-3 col-12 row">
                        <label for="" class="">Categories<span style="color: red;">*</span></label>
                        <div class="col-md-6 mb-4">                            
                            <div class="select2-primary">
                                <select id="projectCategories" name="projectCategories[]"  class="select2" multiple="" data-select2-id="select2Multiple" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="select2-primary">
                                <select id="projectForbiddenCategories" name="projectForbiddenCategories[]"  class="select2" multiple="" data-select2-id="select2Multiple" tabindex="-1" aria-hidden="true">
