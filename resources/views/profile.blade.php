...
<style>
    ...
    .firstlogin-popup{ background-image: url('{{ asset('public/img/pages/firstloginbg.png') }}');background-repeat: no-repeat;background-size: cover;border-top-right-radius: 12px;background-position: bottom;border-top-left-radius: 12px; }
    #advertiserModal{ display: block; }
    #advertiserModal .modal-dialog{ background-color: transparent;height: auto;width: 100%;max-width: 400px; }
    #advertiserModal .modal-content{ background-color: transparent;height: inherit;padding: 0;}
    #advertiserModal .firstlogin_price{ color:#1C8ADB; }
    .mt-negative-15{ margin-top: -15px; }
    </style>
@endpush
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="user-profile-header-banner">
                    <img src="{{ asset_url('img/pages/profile-banner.png') }}" alt="Banner image" class="rounded-top" style="height:70px" />
                </div>
                <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                    <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                        <img src="<?= (!empty($user->image)) ? url('storage/app/'. $user->image) : asset_url('img/avatars/1.png'); ?>" alt="user image" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img" />
                    </div>
                        ...
                        <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
                            <div class="user-profile-info">
                                ...
                                <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                    ...
                                    @if($user->country != '')
                                    <li class="list-inline-item d-flex gap-1"><i class="ti ti-map-pin"></i> {{ $user->country }}</li>
                                    @endif
                                    <!-- <li class="list-inline-item d-flex gap-1">
                            ...
                            <div>
                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#change-password-pop" id="changePasswordBtn" class="btn btn-primary">
                                    <i class="ti ti-lock-cog me-1"></i>Change Password
                                </a>
                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#edit-user-detail-pop" id="editUserDetailBtn" class="btn btn-primary">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-crown text-heading"></i><span class="fw-medium mx-2 text-heading">Role:</span> <span>{{ $user->role->name }}</span>
                        </li>
                        @endif
                        @if(!empty($user->country))
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-world-pin text-heading"></i><span class="fw-medium mx-2 text-heading">Country:</span> <span>{{ $user->country }}</span>
                        </li>
                        @endif
                        @if(!empty($user->identity))
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-id-badge-2 text-heading"></i><span class="fw-medium mx-2 text-heading">Who are you?:</span> <span>{{ $user->identity }}</span>
                        </li>
                        @endif
                        @if(!empty($user->company_website_url))
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-world-www text-heading"></i><span class="fw-medium mx-2 text-heading">Company Website:</span> <span>{{ $user->company_website_url }}</span>
                        </li>
                        @endif
                        <!-- <li class="d-flex align-items-center mb-3">
                    ...
                    <ul class="list-unstyled mb-0 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Country:</span><span>{{ $user->country }}</span>
                            </div>
                        </li>
                        @endif
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Preferred Method:</span><span>{{ $user->preferred_method }}</span>
                            </div>
                        </li>
                        @endif
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Preferred Email:</span><span>{{ $user->payment_email }}</span>
                            </div>
                        </li>
                        @endif
                    </ul>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Business Name:</span><span>{{ $user->business_name }}</span>
                            </div>
                        </li>
                        @endif
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Registration Number:</span><span>{{ $user->registration_number }}</span>
                            </div>
                        </li>
                        @endif
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Billing Address:</span><span>{{ $user->billing_address }}</span>
                            </div>
                        </li>
                        @endif
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Billing City:</span><span>{{ $user->billing_city }}</span>
                            </div>
                        </li>
                        @endif
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Billing Country:</span><span>{{ $user->billing_country }}</span>
                            </div>
                        </li>
                        @endif
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Postal Code:</span><span>{{ $user->postal_code }}</span>
                            </div>
                        </li>
                        @endif
                    </ul>
    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                @endif
                <form method="POST" action="{{ route('user.update', $user->id) }}" class="needs-validation" id="user-update-form" novalidate enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <?php if(isset($user->image) && !empty($user->image)){ ?>
                            <div class="mb-3 col-12 col-md-12 fv-plugins-icon-container text-center">
                                <img src="{{ url('/storage/app/' . $user->image) }}" alt="Profile Image" class="text-center" width="100">
                            </div>
                        <?php } ?>
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            <label class="form-label" for="inputImage">Upload Profile Image</label>
                            <input class="form-control" type="file" name="image" id="inputImage" placeholder="Upload Image">
                        ...
                        <div class="mb-3 col-12 col-md-12">
                            <input type="checkbox" id="whatsapp_msg" name="whatsapp_msg" checked />
                            <label for="whatsapp_msg">Send me the order updates and the best offers and discount on my <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#25D366" height="15px" width="15px" version="1.1" id="Layer_1" viewBox="0 0 308 308" xml:space="preserve" stroke="#25D366">
                            ...
                            </g></svg>whatsapp number.</label>
                        </div>
                        
                        <div class="mb-3 col-12 col-md-12">
                            <label for="how_hear_about_us" class="mb-2">How did you hear about us?</label>
                            <div id="how_hear_about_us" class="row">
                                <div class="col-6">
                                <div class="form-check">
                                    <input type="radio" id="search_engine" name="how_hear_about_us" value="Search Engine" class="form-check-input" />
                                    <label for="search_engine" class="form-check-label">Search Engine</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="word_of_mouth" name="how_hear_about_us" value="Word of Mouth" class="form-check-input" />
                                    <label for="word_of_mouth" class="form-check-label">Word of Mouth</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="social_media_ads" name="how_hear_about_us" value="Social Media Ads" class="form-check-input" />
                                    <label for="social_media_ads" class="form-check-label">Social Media Ads</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="chrome_extension" name="how_hear_about_us" value="Chrome Extension" class="form-check-input" />
                                    <label for="chrome_extension" class="form-check-label">Chrome Extension</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="event_specify" name="how_hear_about_us" value="Event (please specify)" class="form-check-input" />
                                    <label for="event_specify" class="form-check-label">Event (please specify)</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="other_specify" name="how_hear_about_us" value="Other (please specify)" class="form-check-input" />
                                    <label for="other_specify" class="form-check-label">Other (please specify)</label>
                                </div>
                                </div>
                                <div class="col-6">
                                <div class="form-check">
                                    <input type="radio" id="social_media" name="how_hear_about_us" value="Social Media" class="form-check-input" />
                                    <label for="social_media" class="form-check-label">Social Media</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="google_ads" name="how_hear_about_us" value="Google Ads" class="form-check-input" />
                                    <label for="google_ads" class="form-check-label">Google Ads</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="third_party_review_site" name="how_hear_about_us" value="Third-Party Review Site" class="form-check-input" />
                                    <label for="third_party_review_site" class="form-check-label">Third-Party Review Site</label>
                                </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-12 col-md-12" id="additional_info_container">
                            ...
                            <textarea id="additional_info" name="additional_info" class="form-control" rows="3" placeholder="Enter any additional information here..."></textarea>
                        </div>
    ...
    <div class="modal-dialog modal-lg modal-simple modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body firstlogin-popup text-center pt-0">
                ...
                <p>Free Credit has been awarded to you. Take advantage of this free credit and place your <span>1st order on the Marketplace.</span></p>
                
                    <a class="openEditProfile btn btn-primary waves-effect waves-light" href="javascript:void(0)">Grab The Deal</a>
