            ...
            <div class="card-widget-separator-wrapper">
                <div class="card-body card-widget-separator">
                    <div class="row gy-4 gy-sm-1">
                        ...
                        <div class="col-sm-6 col-lg-4 cursor-pointer">
                            <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-3 pb-sm-0 linksCard" data-href="{{ route('lslbadmin.websites') }}">
                                <div>
                        ...
                        <div class="col-sm-6 col-lg-4 cursor-pointer">
                            <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-3 pb-sm-0 linksCard" data-href="{{ route('lslbadmin.orders') }}">
                                <div>
                                    <h4 class="mb-2">{{ $orderCount }}</h4>
