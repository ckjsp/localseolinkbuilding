...
(function () {
  const nav = document.querySelector(".layout-navbar"),
    ...
    swiperWhyus = document.getElementById("swiper-whyus"),
    WhyusPreviousBtn = document.getElementById("whyus-previous-btn"),
    WhyusNextBtn = document.getElementById("whyus-next-btn"),
    WhyusSliderPrev = document.querySelector(".whyus-button-prev"),
    WhyusSliderNext = document.querySelector(".whyus-button-next"),
  ...
  if (swiperWhyus) {
    new Swiper(swiperWhyus, {
      ...
      loopAdditionalSlides: 1,
      navigation: {
        nextEl: ".whyus-button-next",
        prevEl: ".whyus-button-prev",
      },
      breakpoints: {
        1200: {
          slidesPerView: 3,
  ...
  WhyusNextBtn.addEventListener("click", function () {
    WhyusSliderNext.click();
  });
  WhyusPreviousBtn.addEventListener("click", function () {
    WhyusSliderPrev.click();
  });
