...
<link rel="stylesheet" href="<?php echo e(asset_url('css/pages/page-profile.css')); ?>" />
<!-- intlTelInput CSS -->
...
<style>
    ...
    .firstlogin-popup {
        background-image: url('<?php echo e(asset("public/img/pages/firstloginbg.png")); ?>');
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-md-10 m-auto">
            ...
            <div class="alert alert-primary remove-msg"><span><?php echo e(session('success')); ?></span></div>
            <?php endif; ?>
            <?php if(session('errorMsg')): ?>
            <div class="alert alert-danger remove-msg"><span><?php echo e(session('errorMsg')); ?></span></div>
            <?php endif; ?>
            <?php if($errors->any()): ?>
            ...
            <?php endif; ?>
            <?php if(session('success') || session('errorMsg') || $errors->any()): ?>
            <script>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="user-profile-header-banner">
                    <img src="<?php echo e(asset_url('img/pages/profile-banner.png')); ?>" alt="Banner image" class="rounded-top"
                        style="height:70px" />
                </div>
                            ...
                            <div class="user-profile-info">
                                ...
                                <ul
                                    ...
                                    <li class="list-inline-item d-flex gap-1">
                                        <i class="ti ti-color-swatch"></i> <?php echo e($user->role->name); ?>
    ...
    <div class="row">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 text-heading">Full
                                Name:</span> <span><?php echo e($user->name); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if($user->status != ''): ?>
                        <!-- <li class="d-flex align-items-center mb-3">
                                                <i class="ti ti-check text-heading"></i><span class="fw-medium mx-2 text-heading">Status:</span> <span><?php echo e(($user->status == 1) ? 'Active' : 'Inactive'); ?></span>
                                                <span></span>
                                            </li> -->
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-check text-heading"></i>
                            <span class="fw-medium mx-2 text-heading">Status:</span>
                            <span><?php echo e(($user->status == 1) ? 'Active' : 'Inactive'); ?></span>
                            <span class="<?php echo e(($user->status == 1) ? 'active-dot' : 'inactive-dot'); ?>"></span>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($user->role->name)): ?>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-crown text-heading"></i><span
                                class="fw-medium mx-2 text-heading">Role:</span> <span><?php echo e($user->role->name); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($user->country)): ?>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-world-pin text-heading"></i><span
                                class="fw-medium mx-2 text-heading">Country:</span> <span><?php echo e($user->country); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($user->identity)): ?>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-id-badge-2 text-heading"></i><span class="fw-medium mx-2 text-heading">Who
                                are you?:</span> <span><?php echo e($user->identity); ?></span>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($user->company_website_url)): ?>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-world-www text-heading"></i><span
                                class="fw-medium mx-2 text-heading">Company Website:</span>
                            <span><?php echo e($user->company_website_url); ?></span>
                        </li>
                        <?php endif; ?>
                        <!-- <li class="d-flex align-items-center mb-3">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <span><?php echo e($user->dial_code); ?> <?php echo e($user->phone_number); ?></span>
                        </li>
                        <?php endif; ?>
                    ...
                    <ul class="list-unstyled mb-0 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span
                                    class="fw-medium me-2 text-heading">Country:</span><span><?php echo e($user->country); ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($user->preferred_method)): ?>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-wallet text-info me-2"></i>
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Preferred
                                    Method:</span><span><?php echo e($user->preferred_method); ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($user->payment_email)): ?>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-mail-dollar text-info me-2"></i>
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Preferred
                                    Email:</span><span><?php echo e($user->payment_email); ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                    </ul>
        ...
        <?php if($user->role->name == 'Advertiser'): ?>
        <div class="col-xl-4 col-lg-5 col-md-5">
            <div class="card mb-4">
                <div class="card-body">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Business
                                    Name:</span><span><?php echo e($user->business_name); ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Registration
                                    Number:</span><span><?php echo e($user->registration_number); ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Billing
                                    Address:</span><span><?php echo e($user->billing_address); ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($user->billing_city)): ?>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-building-skyscraper text-primary me-2"></i>
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Billing
                                    City:</span><span><?php echo e($user->billing_city); ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        <?php if(!empty($user->billing_country)): ?>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-world-pin text-primary me-2"></i>
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Billing
                                    Country:</span><span><?php echo e($user->billing_country); ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-wrap">
                                <span class="fw-medium me-2 text-heading">Postal
                                    Code:</span><span><?php echo e($user->postal_code); ?></span>
                            </div>
                        </li>
                        <?php endif; ?>
                    </ul>
        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <div class="text-center mb-4">
                    <h3 class="mb-2"><?php echo e(__('Change Password')); ?></h3>
                </div>
                <?php if(session('error')): ?>
                <div class="alert alert-danger"><span><?php echo e(session('error')); ?></span></div>
                <?php endif; ?>
                <form method="POST" action="<?php echo e(route('password.change.update')); ?>" id="change-password-form">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="text-center mb-4">
                    <h3 class="mb-2"><?php echo e(__('Edit User Detail')); ?></h3>
                </div>
                <?php if(session('error')): ?>
                ...
                <?php endif; ?>
                <form method="POST" action="<?php echo e(route('user.update', $user->id)); ?>" class="needs-validation"
                    id="user-update-form" novalidate enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" id="user_role" name="user_role" value="<?php echo e($user->role->name); ?>">
                    <input type="hidden" id="user_role_id" name="user_role_id" value="<?php echo e($user->role->id); ?>">
                    <input type="hidden" id="user_id" name="user_id" value="<?php echo e($user->id); ?>">
                    <input type="hidden" id="dial_code" name="dial_code"
                        value="<?php echo e(!empty($user->dial_code) ? $user->dial_code : '+91'); ?>">
                    <div class="row">
                        <?php if (isset($user->image) && !empty($user->image)) { ?>
                            <div class="mb-3 col-12 col-md-12 fv-plugins-icon-container text-center">
                                <img src="<?php echo e(url('/storage/app/' . $user->image)); ?>" alt="Profile Image" class="text-center"
                                    width="100">
                            </div>
                        <?php } ?>
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            ...
                            <input type="hidden" id="old_image" name="old_image" value="<?php echo e($user->image); ?>">
                        </div>
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            <label class="form-label" for="inputName">Name</label>
                            <input class="form-control" type="text" name="name" id="inputName" value="<?php echo e($user->name); ?>"
                        ...
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            ...
                            <input type="text" id="inputPhoneNumber" name="phone_number"
                                value="<?php echo e($user->phone_number); ?>" class="form-control inputPhoneNumber"
                                placeholder="9856485236">
                        </div>
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            <label class="form-label"
                                for="inputIdentity"><?php echo e($user->role->name == 'Advertiser' ? 'Identity' : 'Who are you?'); ?></label>
                            <select name="identity" id="inputIdentity" class="form-select">
                                <option value="individual link builder" <?php echo e($user->identity == 'individual link builder' ? 'selected' : ''); ?>>Individual Link Builder</option>
                                <option value="in-house team" <?php echo e($user->identity == 'in-house team' ? 'selected' : ''); ?>>
                                    In-House Team</option>
                                <option value="agency" <?php echo e($user->identity == 'agency' ? 'selected' : ''); ?>>Agency</option>
                            </select>
                        </div>
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            ...
                            <input class="form-control" type="text" name="company_website_url"
                                value="<?php echo e($user->company_website_url); ?>" id="inputCompanyWebsite"
                                placeholder="Company Website">
                        </div>
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            <label class="form-label" for="inputCountry">Country</label>
                            <select name="country" id="inputCountry" class="form-select"
                                data-val="<?php echo e(!empty($user->country) ? $user->country : 'india'); ?>">
                            </select>
                            <!-- <option value="india" <?php echo e($user->country == 'india' ? 'selected' : ''); ?>>india</option> -->
                        </div>
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            ...
                            <select name="preferred_method" id="inputPreferredMethod" class="form-select">
                                <option value="paypal" <?php echo e($user->preferred_method == 'paypal' ? 'selected' : ''); ?>>PayPal
                                </option>
                                <!-- <option value="stripe" <?php echo e($user->preferred_method == 'stripe' ? 'selected' : ''); ?>>Stripe
                                </option> -->
                                <option value="razorpay" <?php echo e($user->preferred_method == 'razorpay' ? 'selected' : ''); ?>>
                                    Razorpay</option>
                            </select>
                        </div>
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            ...
                            <input class="form-control" type="text" name="payment_email"
                                value="<?php echo e($user->payment_email); ?>" id="inputPaymentEmail"
                                placeholder="Enter Payment Email">
                        </div>

                        <?php if($user->role->name == 'Advertiser'): ?>
                        <div class="mb-3 col-12 col-md-12">
                            <input type="checkbox" id="whatsapp_msg" name="whatsapp_msg" <?php echo e($user->whatsapp_msg ? 'checked' : ''); ?> />
                                ...
                                <div class="col-6">
                                    <div class="form-check">
                                        <input type="radio" id="search_engine" name="how_hear_about_us"
                                            value="Search Engine" class="form-check-input" <?php echo e($user->how_hear_about_us == 'Search Engine' ? 'checked' : ''); ?> />
                                    ...
                                    <div class="form-check">
                                        <input type="radio" id="word_of_mouth" name="how_hear_about_us"
                                            value="Word of Mouth" class="form-check-input" <?php echo e($user->how_hear_about_us == 'Word of Mouth' ? 'checked' : ''); ?> />
                                    ...
                                    <div class="form-check">
                                        <input type="radio" id="social_media_ads" name="how_hear_about_us"
                                            value="Social Media Ads" class="form-check-input" <?php echo e($user->how_hear_about_us == 'Social Media Ads' ? 'checked' : ''); ?> />
                                    ...
                                    <div class="form-check">
                                        <input type="radio" id="chrome_extension" name="how_hear_about_us"
                                            value="Chrome Extension" class="form-check-input" <?php echo e($user->how_hear_about_us == 'Chrome Extension' ? 'checked' : ''); ?> />
                                    ...
                                    <div class="form-check">
                                        <input type="radio" id="event_specify" name="how_hear_about_us"
                                            value="Event (please specify)" class="form-check-input" <?php echo e($user->how_hear_about_us == 'Event (please specify)' ? 'checked' : ''); ?> />
                                        <label for="event_specify" class="form-check-label">Event (please
                                            specify)</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" id="other_specify" name="how_hear_about_us"
                                            value="Other (please specify)" class="form-check-input" <?php echo e($user->how_hear_about_us == 'Other (please specify)' ? 'checked' : ''); ?> />
                                ...
                                <div class="col-6">
                                    <div class="form-check">
                                        <input type="radio" id="social_media" name="how_hear_about_us"
                                            value="Social Media" class="form-check-input" <?php echo e($user->how_hear_about_us == 'Social Media' ? 'checked' : ''); ?> />
                                    ...
                                    <div class="form-check">
                                        <input type="radio" id="google_ads" name="how_hear_about_us" value="Google Ads"
                                            class="form-check-input" <?php echo e($user->how_hear_about_us == 'Google Ads' ? 'checked' : ''); ?> />
                                    ...
                                    <div class="form-check">
                                        <input type="radio" id="third_party_review_site" name="how_hear_about_us"
                                            value="Third-Party Review Site" class="form-check-input" <?php echo e($user->how_hear_about_us == 'Third-Party Review Site' ? 'checked' : ''); ?> />
                        ...
                        <div class="mb-3 col-12 col-md-12" id="additional_info_container">
                            ...
                            <textarea id="additional_info" name="additional_info" class="form-control" rows="3"
                                placeholder="Enter any additional information here..."><?php echo e($user->additional_info); ?></textarea>
                        </div>
                        ...
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            ...
                            <input class="form-control" type="text" name="business_name"
                                value="<?php echo e($user->business_name); ?>" id="inputBusinessName"
                        ...
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            ...
                            <input class="form-control" type="text" name="registration_number"
                                value="<?php echo e($user->registration_number); ?>" id="inputRegistrationNumber"
                        ...
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            ...
                            <select name="billing_country" id="inputBillingCountry" class="form-select"
                                data-val="<?php echo e(!empty($user->billing_country) ? $user->billing_country : 'india'); ?>">
                            </select>
                            <!-- <option value="india" <?php echo e($user->billing_country == 'india' ? 'selected' : ''); ?>>india</option> -->
                        </div>
                        <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            <label class="form-label" for="inputPostalCode">Postal Code</label>
                            <input class="form-control" type="number" name="postal_code"
                                value="<?php echo e($user->postal_code); ?>" id="inputPostalCode" placeholder="Enter Postal Code">
                        </div>
                        <?php endif; ?>
                    </div>
...
<?php if($user->role->name == 'Advertiser'): ?>
<?php if(session('show_advertiser_modal')): ?>
        ...
        <div class="modal-content">
            <div class="modal-body firstlogin-popup text-center pt-0">
                <div class="text-center mb-4 p-2 pt-0 mt-negative-15">
                    <img src="<?php echo e(asset('public/img/pages/gifticon.png')); ?>">
                </div>
                <div>
...
<div class="modal fade" id="change-password-pop" tabindex="-1" style="display: none;" aria-hidden="true">
    ...
    <script src="<?php echo e(asset_url('js/pages-profile.js')); ?>"></script>
    <!-- intlTelInput JS -->
    <script src="<?php echo e(asset_url('libs/intlTelInput/intlTelInput.min.js')); ?>"></script>

    <script src="<?php echo e(asset_url('script/profile.js')); ?>"></script>
    <?php $__env->stopPush(); ?>
<?php echo $__env->make($page, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/profile.blade.php ENDPATH**/ ?>