        ...
        <div class="row app-logistics-fleet-wrapper mb-5">
                                ...
                                <div role="button" class="accordion-button shadow-none align-items-center w-75 bg-label-primary" data-bs-toggle="collapse" data-bs-target="#fleet1" aria-expanded="true" aria-controls="fleet1">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="d-flex flex-column">
                                            <span class="h6 mb-0 text-primary"><?php echo e($order[0]->order_id); ?></span>
                                            <span class="text-muted"><?php echo e($order[0]->type); ?></span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <ul class="timeline ps-3 mt-4 mb-0">
                                        <li class="timeline-item ms-1 ps-4 border-left-dashed">
                                            ...
                                            <div class="timeline-event ps-0 pb-0">
                                                ...
                                                <p class="text-muted mb-0"><?php echo e(date('M d, H:i A', strtotime($order[0]->created_at))); ?></p>
                                            </div>
                                        </li>
                                        <?php if($order[0]->status == 'in-progress' || $order[0]->status == 'approved' || $order[0]->status == 'delayed' || $order[0]->status == 'rejected' || $order[0]->status == 'complete'): ?>
                                        <li class="timeline-item ms-1 ps-4 border-left-dashed">
                                            <span class="timeline-indicator-advanced timeline-indicator-success border-0 shadow-none">
                                            ...
                                            <div class="timeline-event ps-0 pb-0">
                                                ...
                                                <h6 class="mb-1"><?php echo e($order[0]->website->user->name); ?></h6>
                                                <p class="text-muted mb-0"><?php echo e($order[0]->website->website_url); ?></p>
                                            </div>
                                        </li>
                                        <?php endif; ?>
                                        <?php if($order[0]->status == 'approved' || $order[0]->status == 'delayed' || $order[0]->status == 'complete'): ?>
                                        <li class="timeline-item ms-1 ps-4 border-left-dashed">
                                            <span class="timeline-indicator-advanced timeline-indicator-success border-0 shadow-none">
                                                <i class="ti ti-circle-check"></i>
                                            </span>
                                        ...
                                        <?php endif; ?>
                                        <?php if($order[0]->status == 'rejected'): ?>
                                        <li class="timeline-item ms-1 ps-4 border-left-dashed">
                                        ...
                                        <li class="timeline-item ms-1 ps-4 border-transparent">
                                            <span class="timeline-indicator-advanced <?php echo e(($order[0]->status == 'complete') ? 'timeline-indicator-success' : 'timeline-indicator-primary'); ?> border-0 shadow-none">
                                                <i class="ti ti-file-certificate mt-1"></i>
                                            </span>
                                            <div class="timeline-event ps-0 pb-0">
                                                <div class="timeline-header">
                                                    <small class="<?php echo e(($order[0]->status == 'complete') ? 'text-success' : 'text-primary'); ?> text-uppercase fw-medium">published</small>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
            ...
            <div class="col h-100 map-container mb-5">
                ...
                <div id="map" class="h-100 w-100">
                    <h3 class="mt-5 text-center text-primary"><?php echo e($order[0]->attachment_type); ?></h3>
                    <div class="border w-75 m-auto mb-3"> </div>
                    <div class="order-detail-section">
                        <div class="row mb-3">
                            <div class="col-md-6"><strong class="m-2 font-bold">Website: </strong> <a href="<?php echo e($order[0]->website->website_url); ?>" target="_blank" class="text-primary"><?php echo e($order[0]->website->website_url); ?></a></div>
                            <?php if($userDetail->role->name == 'Advertiser'): ?>
                            <div class="col-md-6"><strong class="m-2 font-bold">Current Status: </strong> <?php echo e($order[0]->status); ?></div>
                            <?php else: ?>
                            <div class="col-md-6">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" id="id" name="id" value="<?php echo e($order[0]->id); ?>">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-label-primary dropdown-toggle waves-effect statusBtnTitle" data-bs-toggle="dropdown" aria-expanded="false">
                                        <?php echo e($order[0]->status); ?>

                                    </button>
                                    <ul class="dropdown-menu" style="">
                                        <li class="dropdown-item order-status <?php echo e($order[0]->status == 'new' ? 'active' : ''); ?>" data-item="new">New</li>
                                        <li class="dropdown-item order-status <?php echo e($order[0]->status == 'in-progress' ? 'active' : ''); ?>" data-item="in-progress">In-Progress</li>
                                        <li class="dropdown-item order-status <?php echo e($order[0]->status == 'delayed' ? 'active' : ''); ?>" data-item="delayed">Delayed</li>
                                        <li class="dropdown-item order-status <?php echo e($order[0]->status == 'approved' ? 'active' : ''); ?>" data-item="approved">Approved</li>
                                        <li class="dropdown-item order-status <?php echo e($order[0]->status == 'rejected' ? 'active' : ''); ?>" data-item="rejected">Rejected</li>
                                        <li class="dropdown-item order-status <?php echo e($order[0]->status == 'complete' ? 'active' : ''); ?>" data-item="complete">Complete</li>
                                    </ul>
                                </div>
                            </div>
                            <?php endif; ?>
                        ...
                        <!-- <div class="col-md-6">
                                <strong class="m-2 font-bold">Type: </strong> <?php echo e($order[0]->attachment_type); ?>

                            </div> -->

                        <?php if($order[0]->attachment_type == 'Guest Post'): ?>

                        <!-- Guest Post Section -->

                        <div class="row mb-3">
                            <div class="col-md-6">
                                <?php if(!empty($order[0]->attachment)): ?>
                                <?php
                                ...
                                <div class="mb-2">
                                    <strong>Article Doc <?php echo e($index + 1); ?>: </strong>
                                    <a href="<?php echo e(url('/storage/app/' . trim($attachment))); ?>" target="_blank" class="btn btn-primary">Download Docx</a>
                                </div>
                        ...
                        <?php elseif($order[0]->attachment_type == 'Link Insertion'): ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-9">
                                ...
                                <?php echo e($order[0]->existing_post_url); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-9">
                                ...
                                <?php echo e($order[0]->landing_page_url); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <?php echo e($order[0]->anchor_text); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6"><strong class="m-2 font-bold">Quantity: </strong> <?php echo e($order[0]->quantity); ?></div>
                            <!-- <div class="col-md-6"><strong class="m-2 font-bold">Total Amount: </strong> $<?php echo e($order[0]->price); ?></div> -->
                        </div>
                        <?php if($userDetail->role->name == 'Admin'): ?>
                        <div class="row mb-3">
                            <div class="col-md-6"><strong class="m-2 font-bold">Payment Method: </strong> <?php echo e($order[0]->payment_method); ?></div>
                            <div class="col-md-6"><strong class="m-2 font-bold">Payment Status: </strong> <?php echo $order[0]->payment_status; ?></div>
                        </div>
                        <?php if(isset($order[0]->payments[0]->payment_type)): ?>
                        <div class="row mb-3">
                            <div class="col-md-6"><strong class="m-2 font-bold">Payment Type: </strong> <?php echo e($order[0]->payments[0]->payment_type); ?></div>
                        </div>
                        <?php endif; ?>
                        <?php endif; ?>
                        <div class="row mb-3">
                            <div class="col-md-12"><strong class="m-2 font-bold">Special Instructions: </strong> <?php echo $order[0]->special_instructions; ?></div>
                        </div>
                        <?php if($order[0]->status == 'complete'): ?>
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <strong class="m-2 font-bold">Complete URL: </strong> <?php echo $order[0]->completion_url; ?>

                            </div>
                        </div>
                        <?php elseif($order[0]->status == 'rejected'): ?>
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <strong class="m-2 font-bold">Rejection reason: </strong> <?php echo $order[0]->rejection_reason; ?>
            ...
            <div class="map-container d-flex justify-content-end mr-5">
                <div class="btn-group mx-5">
                    <button type="button" class="btn btn-outline-primary mx-5 orderStatus disabled" data-item="<?php echo e($order[0]->status); ?>">Save Status</button>
                </div>
            </div>
            <?php endif; ?>
            <!-- Overlay Hidden -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make($page, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/order_info.blade.php ENDPATH**/ ?>