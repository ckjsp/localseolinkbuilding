    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
        ...
        <section class="section-py">
            <div class="container">
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-6  col-sm-12">
                        <img src="<?php echo e(asset_url('img/Why Partner.png')); ?>" alt="Why Partner" width="100%">
                    </div>
                </div>
        </section>
        ...
        <section class="section-py pt-0">
            <div class="container">
                <div class="row gx-5">
                    <div class="col-lg-6  col-sm-12">
                        <img src="<?php echo e(asset_url('img/SEO Reseller.png')); ?>" alt="SEO Reseller" width="100%">
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingOne">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                What is an SEO reseller program? Explain! </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-headingThree">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                What kind of SEO services are typically offered through reseller programs?
                            </button>
                        </h2>
...
</html><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/pages/seoresellerservices.blade.php ENDPATH**/ ?>