...
<aside class="layout-menu menu-vertical menu bg-menu-theme " style="width: 300px; overflow-y: auto;">
    <div class="app-brand demo">
        <a href="<?php echo e(route('publisher')); ?>" class="app-brand-link">
            ...
            <img src="<?php echo e(asset_url('img/header-logo.png')); ?>" alt="Logo" class="w-100 full-logo">
        </a>
    ...
    <form name="websitefilter" id="websitefilter" class="websitefilter">
        <input type="hidden" id="url" value="<?php echo e(url('website/filter')); ?>">
...
</aside><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/advertiser/filter_second.blade.php ENDPATH**/ ?>