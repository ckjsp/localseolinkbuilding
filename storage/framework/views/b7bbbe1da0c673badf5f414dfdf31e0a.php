...
<?php $__env->stopPush(); ?>
<link rel="stylesheet" href="<?php echo e(asset_url('libs/shepherd/shepherd.css')); ?>" />
<!-- Content -->
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                        <div class="avatar me-2">
                            <a href="<?php echo e(url('/advertiser/orders')); ?>"><span
                    ...
                    <p class="mb-0">
                        <span class="fw-medium me-1"><?php echo e($pendingOrderCount); ?></span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="competitorForm" action="<?php echo e(route('addcompetitor')); ?>" method="POST"
                    onsubmit="return handleCompetitorFormSubmit()">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" id="projectId" name="project_id">
                    <div class="mb-3">
                        <label for="competitorUrl" class="form-label">Competitor URL</label>
                        <input type="text" class="form-control" id="competitorUrl" name="add_competitor"
                            placeholder="Enter competitor URL" required oninput="validateCompetitorUrl()">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('advertiser.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/advertiser/home.blade.php ENDPATH**/ ?>