...
<nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme shadow-none" id="layout-navbar">
    <div class="container-xxl">
        <?php if(!isset($slug) || $slug != 'marketplace'): ?>
        <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
            <a href="<?php echo e(url('/')); ?>" class="app-brand-link gap-2">
                <img src="<?php echo e(asset_url('img/header-logo.png')); ?>" alt="Logo" class="w-75">
            </a>
        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item me-2 me-xl-0">
                    <a class="nav-link cart nav-cart-icon <?php echo e((isset($slug) && $slug == 'cart') ? 'text-primary' : ''); ?>"
                        href="<?php echo e(route('advertiser.cart')); ?>" data-item-count="0">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                ...
                                <span class="align-middle"><?php echo e(__('Log Out')); ?></span>
                            </a>
...
<!-- / Navbar --><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/includes/second_navbar.blade.php ENDPATH**/ ?>