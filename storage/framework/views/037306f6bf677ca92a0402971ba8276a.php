    ...
    <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
        ...
        <div class="navbar-nav-right d-flex align-items-center mx-2" id="navbar-collapse">
            <!-- Search -->
    ...
    <!-- / Navbar --><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/includes/navbar.blade.php ENDPATH**/ ?>