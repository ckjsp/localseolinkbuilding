        ...
        <section class="mb-100">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <figure class="figure">
                            <img src="<?php echo e(asset_url('img/transform-strategy/Wealth of Knowledge.png')); ?>" alt="Content Syndication">
                            <a href="<?php echo e(route('easy-ways')); ?>" class="text-decoration-none">
                    ...
                    <div class="col-lg-6">
                        <figure class="figure">
                            <img src="<?php echo e(asset_url('img/transform-strategy/Links Farmer.png.png')); ?>" alt="Content Syndication">
                            <a href="<?php echo e(route('manual-outreach')); ?>" class="text-decoration-none">
...
</html><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/pages/blogpage.blade.php ENDPATH**/ ?>