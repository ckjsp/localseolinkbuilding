...
<div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <?php echo e(__('Update Website Detail')); ?>

                    <a href="<?php echo e(url()->previous()); ?>" class="btn btn-outline-primary float-end"><i class="ti ti-arrow-narrow-left mx-1"></i> Go Back</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="border rounded p-5 mt-5 bg-white">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <form class="row g-3" action="<?php echo e((isset($website) && !empty($website)) ? route('lslbadmin.website.update', $website->id) : route('lslbadmin.website.store')); ?>" method="Post" id="addWebsiteForm" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="col-md-12">
                        <label for="inputWebUrl" class="form-label">Website URL</label>
                        <input type="text" class="form-control" id="inputWebUrl" name="website_url" placeholder="https://example.com" value="<?php echo e($website->website_url); ?>">
                    </div>
                    <?php echo method_field('PUT'); ?>
                    <input type="hidden" id="id" name="id" value="<?php echo e($website->id); ?>">
                    <input type="hidden" name="old_url" value="<?php echo e($website->website_url); ?>">

                    <div class="col-md-4">
                        <label for="inputDomainAuthority" class="form-label">DA <small>Domain Authority</small></label>
                        <input type="number" class="form-control" id="inputDomainAuthority" name="domain_authority" mix="0" max="100" value="<?php echo e((isset($website->domain_authority) && !empty($website->domain_authority)) ? $website->domain_authority : 0); ?>" placeholder="DA (domain Authority)">
                    </div>
                    <div class="col-md-4">
                        <label for="inputPageAuthority" class="form-label">PA <small>Page Authority</small></label>
                        <input type="number" class="form-control" id="inputPageAuthority" name="page_authority" mix="0" max="100" value="<?php echo e((isset($website->page_authority) && !empty($website->page_authority)) ? $website->page_authority : 0); ?>" placeholder="PA (Page Authority)">
                    </div>
                    <div class="col-md-4">
                        <label for="inputSpamScore" class="form-label">Spam Score</label>
                        <input type="number" class="form-control" id="inputSpamScore" name="spam_score" mix="0" max="100" value="<?php echo e((isset($website->spam_score) && !empty($website->spam_score)) ? $website->spam_score : 0); ?>" placeholder="Spam Score">
                    </div>
                    <div class="col-md-4">
                        ...
                        <select id="inputPublishingTime" class="select2 form-select" name="publishing_time" data-allow-clear="true">
                            <option value="" <?php echo e((!isset($website->publishing_time) || empty($website->publishing_time)) ? 'selected' : ''); ?>>Select Day</option>
                            <option value="1" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 1) ? 'selected' : ''); ?>>1 Days</option>
                            <option value="2" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 2) ? 'selected' : ''); ?>>2 Days</option>
                            <option value="3" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 3) ? 'selected' : ''); ?>>3 Days</option>
                            <option value="4" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 4) ? 'selected' : ''); ?>>4 Days</option>
                            <option value="5" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 5) ? 'selected' : ''); ?>>5 Days</option>
                            <option value="6" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 6) ? 'selected' : ''); ?>>6 Days</option>
                            <option value="7" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 7) ? 'selected' : ''); ?>>7 Days</option>
                            <option value="8" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 8) ? 'selected' : ''); ?>>8 Days</option>
                            <option value="9" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 9) ? 'selected' : ''); ?>>9 Days</option>
                            <option value="10" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 10) ? 'selected' : ''); ?>>10 Days</option>
                            <option value="11" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 11) ? 'selected' : ''); ?>>11 Days</option>
                            <option value="12" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 12) ? 'selected' : ''); ?>>12 Days</option>
                            <option value="13" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 13) ? 'selected' : ''); ?>>13 Days</option>
                            <option value="14" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 14) ? 'selected' : ''); ?>>14 Days</option>
                            <option value="15" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 15) ? 'selected' : ''); ?>>15 Days</option>
                            <option value="60" <?php echo e((!empty($website->publishing_time) && $website->publishing_time == 60) ? 'selected' : ''); ?>>60 Days</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label for="inputWordCount" class="form-label">Minimum Word Count Required</label>
                        <input type="number" class="form-control" id="inputWordCount" mix="0" max="1000" value="<?php echo e((isset($website->minimum_word_count_required) && !empty($website->minimum_word_count_required)) ? $website->minimum_word_count_required : 0); ?>" name="minimum_word_count_required">
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="row bg-light rounded p-2 w-75 mx-2">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="backlink_type" id="inputBacklinkType1" value="dofollow" <?php echo e((!empty($website->backlink_type) && $website->backlink_type == 'dofollow') ? 'checked' : ''); ?>>
                                    <label class="form-check-label" for="inputBacklinkType1">DoFollow</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="backlink_type" id="inputBacklinkType2" value="nofollow" <?php echo e((!empty($website->backlink_type) && $website->backlink_type == 'nofollow' || !isset($website->backlink_type)) ? 'checked' : ''); ?>>
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="inputBacklinksAllowed" class="select2 form-select" name="maximum_no_of_backlinks_allowed" data-allow-clear="true">
                            <option value="" <?php echo e((!isset($website->maximum_no_of_backlinks_allowed) || empty($website->maximum_no_of_backlinks_allowed)) ? 'selected' : ''); ?>>Select number of link</option>
                            <option value="1" <?php echo e((!empty($website->maximum_no_of_backlinks_allowed) && $website->maximum_no_of_backlinks_allowed == '1') ? 'selected' : ''); ?>>1</option>
                            <option value="2" <?php echo e((!empty($website->maximum_no_of_backlinks_allowed) && $website->maximum_no_of_backlinks_allowed == '2') ? 'selected' : ''); ?>>2</option>
                            <option value="3" <?php echo e((!empty($website->maximum_no_of_backlinks_allowed) && $website->maximum_no_of_backlinks_allowed == '3') ? 'selected' : ''); ?>>3</option>
                            <option value="4" <?php echo e((!empty($website->maximum_no_of_backlinks_allowed) && $website->maximum_no_of_backlinks_allowed == '4') ? 'selected' : ''); ?>>4</option>
                            <option value="5" <?php echo e((!empty($website->maximum_no_of_backlinks_allowed) && $website->maximum_no_of_backlinks_allowed == '5') ? 'selected' : ''); ?>>5</option>
                            <option value="5+" <?php echo e((!empty($website->maximum_no_of_backlinks_allowed) && $website->maximum_no_of_backlinks_allowed == '5+') ? 'selected' : ''); ?>>5+</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                        ...
                        <select id="inputDomainLifeValidity" class="form-select select2" name="domain_life_validity" data-allow-clear="true">
                            <option value="" <?php echo e((!isset($website->domain_life_validity) || empty($website->domain_life_validity)) ? 'selected' : ''); ?>>Select domain life validity</option>
                            <option value="Permanent" <?php echo e((!empty($website->domain_life_validity) && $website->domain_life_validity == 'Permanent') ? 'selected' : ''); ?>>Permanent</option>
                            <option value="Atleast for 1 year" <?php echo e((!empty($website->domain_life_validity) && $website->domain_life_validity == 'Atleast for 1 year') ? 'selected' : ''); ?>>Atleast for 1 year</option>
                            <option value="Atleast for 2 years" <?php echo e((!empty($website->domain_life_validity) && $website->domain_life_validity == 'Atleast for 2 years') ? 'selected' : ''); ?>>Atleast for 2 years</option>
                        </select>
                    </div>
                    <div class="col-md-8">
                        <label for="inputSamplePostUrl" class="form-label">Sample Post URL</label>
                        <input type="text" class="form-control" id="inputSamplePostUrl" name="sample_post_url" value="<?php echo e((isset($website->sample_post_url) && !empty($website->sample_post_url)) ? $website->sample_post_url : ''); ?>" placeholder="https://example.com/post">
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="inputStatus" class="select2 form-select" name="status" data-allow-clear="true">
                            <option value="pending" <?php echo e((!empty($website->status) && $website->status == 'pending') ? 'selected' : ''); ?>>Pending</option>
                            <option value="in-review" <?php echo e((!empty($website->status) && $website->status == 'in-review') ? 'selected' : ''); ?>>In Review</option>
                            <option value="approve" <?php echo e((!empty($website->status) && $website->status == 'approve') ? 'selected' : ''); ?>>Approve</option>
                            <option value="rejected" <?php echo e((!empty($website->status) && $website->status == 'rejected') ? 'selected' : ''); ?>>Rejected</option>
                        </select>
                    </div>
                    <div class="col-md-12">
                        <label for="inputGuidelines" class="form-label">Guidelines</label>
                        <textarea class="form-control" id="inputGuidelines" rows="7" name="guidelines" value="<?php echo e((isset($website->guidelines) && !empty($website->guidelines)) ? $website->guidelines : ''); ?>" placeholder="If you have any specific guidelines regarding word limit, backlink count, anchor text selection, etc. mention them below."><?php echo e((isset($website->guidelines) && !empty($website->guidelines)) ? $website->guidelines : ''); ?></textarea>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <ul>
                        ...
                        <div class="col-md-6">
                            <p style="float :right; font-size: 14px; color: #275570; margin-top: 5px;"> <span id="inputGuidelinesTextCount" class="badge badge-pill bg-info"><?php echo e((isset($website->guidelines) && !empty($website->guidelines)) ? (1000-strlen($website->guidelines)) : 1000); ?></span> Character(s) Remaining</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        ...
                        ?>
                        <input type="hidden" id="inputCategories" name="categories" value="<?php echo e((isset($website->categories) && !empty($website->categories)) ? $website->categories : ''); ?>">
                        ...
                        <div class="select2-primary">
                            <select id="inputCategories1" class="form-select select2" multiple>
                                ...
                                <option value="Automobiles" <?php echo e((in_array("Automobiles", $Carr)) ? 'selected' : ''); ?>>Automobiles</option>
                                <option value="Beauty" <?php echo e((in_array("Beauty", $Carr)) ? 'selected' : ''); ?>>Beauty</option>
                                <option value="Blogging" <?php echo e((in_array("Blogging", $Carr)) ? 'selected' : ''); ?>>Blogging</option>
                                <option value="Business" <?php echo e((in_array("Business", $Carr)) ? 'selected' : ''); ?>>Business</option>
                                <option value="Career & Employment" <?php echo e((in_array("Career & Employment", $Carr)) ? 'selected' : ''); ?>>Career & Employment</option>
                                <option value="Computer & Electronics" <?php echo e((in_array("Computer & Electronics", $Carr)) ? 'selected' : ''); ?>>Computer & Electronics</option>
                                <option value="Coupons Offers & Cashback" <?php echo e((in_array("Coupons Offers & Cashback", $Carr)) ? 'selected' : ''); ?>>Coupons Offers & Cashback</option>
                                <option value="Digital Marketing" <?php echo e((in_array("Digital Marketing", $Carr)) ? 'selected' : ''); ?>>Digital Marketing</option>
                                <option value="Education" <?php echo e((in_array("Education", $Carr)) ? 'selected' : ''); ?>>Education</option>
                                <option value="Environment" <?php echo e((in_array("Environment", $Carr)) ? 'selected' : ''); ?>>Environment</option>
                                <option value="Family" <?php echo e((in_array("Family", $Carr)) ? 'selected' : ''); ?>>Family</option>
                                <option value="Fashion & Lifestyle" <?php echo e((in_array("Fashion & Lifestyle", $Carr)) ? 'selected' : ''); ?>>Fashion & Lifestyle</option>
                                <option value="Finance" <?php echo e((in_array("Finance", $Carr)) ? 'selected' : ''); ?>>Finance</option>
                                <option value="Food & Drink" <?php echo e((in_array("Food & Drink", $Carr)) ? 'selected' : ''); ?>>Food & Drink</option>
                                ...
                                <option value="Health & Fitness" <?php echo e((in_array("Health & Fitness", $Carr)) ? 'selected' : ''); ?>>Health & Fitness</option>
                                ...
                                <option value="Internet & Telecom" <?php echo e((in_array("Internet & Telecom", $Carr)) ? 'selected' : ''); ?>>Internet & Telecom</option>
                                <option value="Law & Government" <?php echo e((in_array("Law & Government", $Carr)) ? 'selected' : ''); ?>>Law & Government</option>
                                <option value="Leisure & Hobbies" <?php echo e((in_array("Leisure & Hobbies", $Carr)) ? 'selected' : ''); ?>>Leisure & Hobbies</option>
                                <option value="Magazine" <?php echo e((in_array("Magazine", $Carr)) ? 'selected' : ''); ?>>Magazine</option>
                                <option value="Manufacturing" <?php echo e((in_array("Manufacturing", $Carr)) ? 'selected' : ''); ?>>Manufacturing</option>
                                <option value="Marketing & Advertising" <?php echo e((in_array("Marketing & Advertising", $Carr)) ? 'selected' : ''); ?>>Marketing & Advertising</option>
                                <option value="Music" <?php echo e((in_array("Music", $Carr)) ? 'selected' : ''); ?>>Music</option>
                                <option value="News & Media" <?php echo e((in_array("News & Media", $Carr)) ? 'selected' : ''); ?>>News & Media</option>
                                <option value="Photography" <?php echo e((in_array("Photography", $Carr)) ? 'selected' : ''); ?>>Photography</option>
                                <option value="Politics" <?php echo e((in_array("Politics", $Carr)) ? 'selected' : ''); ?>>Politics</option>
                                <option value="Quotes" <?php echo e((in_array("Quotes", $Carr)) ? 'selected' : ''); ?>>Quotes</option>
                                <option value="Real estate" <?php echo e((in_array("Real estate", $Carr)) ? 'selected' : ''); ?>>Real estate</option>
                                <option value="Region" <?php echo e((in_array("Region", $Carr)) ? 'selected' : ''); ?>>Region</option>
                                <option value="Reviews" <?php echo e((in_array("Reviews", $Carr)) ? 'selected' : ''); ?>>Reviews</option>
                                <option value="Science" <?php echo e((in_array("Science", $Carr)) ? 'selected' : ''); ?>>Science</option>
                                <option value="Shopping" <?php echo e((in_array("Shopping", $Carr)) ? 'selected' : ''); ?>>Shopping</option>
                                <option value="Spanish" <?php echo e((in_array("Spanish", $Carr)) ? 'selected' : ''); ?>>Spanish</option>
                                <option value="Sports" <?php echo e((in_array("Sports", $Carr)) ? 'selected' : ''); ?>>Sports</option>
                                <option value="Sprituality" <?php echo e((in_array("Sprituality", $Carr)) ? 'selected' : ''); ?>>Sprituality</option>
                                <option value="Technology" <?php echo e((in_array("Technology", $Carr)) ? 'selected' : ''); ?>>Technology</option>
                                <option value="Travelling" <?php echo e((in_array("Travelling", $Carr)) ? 'selected' : ''); ?>>Travelling</option>
                                <option value="Web development" <?php echo e((in_array("Web development", $Carr)) ? 'selected' : ''); ?>>Web development</option>
                                <option value="Wedding" <?php echo e((in_array("Wedding", $Carr)) ? 'selected' : ''); ?>>Wedding</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        ...
                        ?>
                        <input type="hidden" id="inputForbiddenCategories" name="forbidden_categories" value="<?php echo e((isset($website->forbidden_categories) && !empty($website->forbidden_categories)) ? $website->forbidden_categories : ''); ?>">
                        ...
                        <div class="select2-info">
                            <select id="inputForbiddenCategories1" class="select2 form-select" multiple>
                                <option value="Casino" <?php echo e((in_array("Casino", $FCarr)) ? 'selected' : ''); ?>>Casino</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="inputGuestPostPrice"
                            value="<?php echo e(isset($website->guest_post_price) ? $website->guest_post_price : 0); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="inputLinkInsertionPrice"
                            value="<?php echo e(isset($website->link_insertion_price) ? $website->link_insertion_price : 0); ?>"
                            name="link_insertion_price" placeholder="$">
                    </div>

                    <!-- Conditionally show admin prices based on session role -->
                    <?php if(session('selected_role') == 1): ?>
                    <div class="col-md-6">
                        <label for="inputGuestPostAdminPrice" class="form-label">Guest post admin price ($)</label>
                        <input type="number" class="form-control" id="inputGuestPostAdminPrice"
                            value="<?php echo e(isset($website->guest_post_admin_price) ? $website->guest_post_admin_price : 0); ?>"
                            name="guest_post_admin_price" placeholder="$">
                    </div>
                    <div class="col-md-6">
                        <label for="inputLinkInsertionAdminPrice" class="form-label">Link insertion admin price ($)</label>
                        <input type="number" class="form-control" id="inputLinkInsertionAdminPrice"
                            value="<?php echo e(isset($website->link_insertion_admin_price) ? $website->link_insertion_admin_price : 0); ?>"
                            name="link_insertion_admin_price" placeholder="$">
                    </div>
                    <?php endif; ?>

                    <!-- <div class="col-md-3">
                        <label for="inputFCGuestPostPrice" class="form-label">FC Guest Post price ($)</label>
                        <input type="number" class="form-control" id="inputFCGuestPostPrice" value="<?php echo e((isset($website->fc_guest_post_price) && !empty($website->fc_guest_post_price)) ? $website->fc_guest_post_price : 0); ?>" name="fc_guest_post_price" placeholder="$">
                    </div> -->
                    <!-- <div class="col-md-3">
                        <label for="inputFCLinkInsertionPrice" class="form-label">FC Link Insertion price ($)</label>
                        <input type="number" class="form-control" id="inputFCLinkInsertionPrice" value="<?php echo e((isset($website->fc_link_insertion_price) && !empty($website->fc_link_insertion_price)) ? $website->fc_link_insertion_price : 0); ?>" name="fc_link_insertion_price" placeholder="$">
                    </div> -->
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <input type="file" name="site_verification_file" id="site_verification_file" class="form-control" <?php echo e((isset($site_verification_file) && !empty($site_verification_file)) ? '' : 'required=""'); ?>>
                        <input type="hidden" name="old_site_verification_file" class="form-control" value="<?php echo e((isset($site_verification_file) && !empty($site_verification_file)) ? $site_verification_file : ''); ?>">
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('lslbadmin.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/lslbadmin/website_create.blade.php ENDPATH**/ ?>