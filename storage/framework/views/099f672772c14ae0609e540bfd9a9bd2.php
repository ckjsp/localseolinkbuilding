    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-12">
            <div class="card mt-2">
                ...
                <?php echo csrf_field(); ?>
                <input type="hidden" id="url" value="<?php echo e(url('lslb-admin/website-status-update')); ?>">
                <div id="alert"></div>
                    ...
                    <table class="table" id="website-tbl">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <tr class="table-body">
                                ...
                                <td>$<?php echo e($v->link_insertion_price); ?> </td>
                                <td>
                                    <button type="button"
                                        class="btn btn-label-primary dropdown-toggle waves-effect statusBtnTitle<?php echo e($v->id); ?>"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <?php echo e(ucwords($v->status)); ?>

                                    </button>
                                    <ul class="dropdown-menu" style="">
                                        <li class="dropdown-item webStatus<?php echo e($v->id); ?> <?php echo e($v->status == 'pending' ? 'active' : ''); ?>" onclick="webStatus($(this), <?= $v->id ?>)" data-item="pending">Pending</li>
                                        <li class="dropdown-item webStatus<?php echo e($v->id); ?> <?php echo e($v->status == 'in-review' ? 'active' : ''); ?>" onclick="webStatus($(this), <?= $v->id ?>)" data-item="in-review">In Review</li>
                                        <li class="dropdown-item webStatus<?php echo e($v->id); ?> <?php echo e($v->status == 'approve' ? 'active' : ''); ?>" onclick="webStatus($(this), <?= $v->id ?>)" data-item="approve">Approve</li>
                                        <li class="dropdown-item webStatus<?php echo e($v->id); ?> <?php echo e($v->status == 'rejected' ? 'active' : ''); ?>" onclick="webStatus($(this), <?= $v->id ?>)" data-item="rejected">Rejected</li>
                                    </ul>
                                </td>
                                <td class="p-0 text-center">
                                    <?php if($v->site_verification_file != ''): ?>
                                    <a href="<?php echo e(url('/storage/app/'.$v->site_verification_file)); ?>" target="_blank"><i
                                ...
                                <td>
                                    <button type="button" class="btn btn-label-success" data-bs-toggle="modal" data-bs-target="#adminPriceModal" onclick="setAdminPriceId('<?php echo e($v->id); ?>')">
                                        Set Price
                                    </button>
                                </td>
                                ...
                                <td>
                                    <button type="button" class="btn p-0 edit-btn text-info"
                                        onclick="window.location.href=`<?php echo e(url('/lslb-admin/website')); ?>/<?php echo e($v->id); ?>/edit`"><i
                                    ...
                                    <button type="button" class="btn p-0 delete-btn text-danger" data-bs-toggle="modal"
                                        ...
                                        onclick="$('.delete-yes-btn').attr('data-href',`<?php echo e(url('/lslb-admin/website')); ?>/<?php echo e($v->id); ?>/delete`);"><i
            ...
            <div class="modal-body">
                ...
                <div class="col-12 text-center">
                    ...
                    <button type="reset" class="btn btn-label-secondary btn-reset waves-effect"
                        onclick="$('#delete-yes-btn').data('href','');" data-bs-dismiss="modal" aria-label="Close"><?php echo e(__('No')); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-simple modal-enable-otp modal-lg modal-dialog-centered">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="text-center mb-4">
                    <h3 class="mb-2"><?php echo e(__('Website Info')); ?></h3>
                </div>
                <div class="container">
                    <div class="row my-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="adminPriceForm">
                    <input type="hidden" name="website_id" value="<?php echo e($v->id); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('lslbadmin.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/lslbadmin/website.blade.php ENDPATH**/ ?>