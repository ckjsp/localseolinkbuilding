...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('public/img/faviconnew.svg')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset_url('css/fonts/tabler-icons.eot')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset_url('css/demo.css')); ?>" />
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('public/img/favicon.svg')); ?>" />
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
        href="https://fonts.googleapis.com/css2?family=Public+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&ampdisplay=swap"
    ...
    <link rel="stylesheet" href="<?php echo e(asset_url('css/rtl/core.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset_url('css/rtl/theme-default.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset_url('css/demo.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset_url('libs/node-waves/node-waves.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset_url('libs/nouislider/nouislider.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset_url('libs/swiper/swiper.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset_url('css/pages/front-page-landing.css')); ?>" />
    <script src="<?php echo e(asset_url('js/helpers.js')); ?>"></script>
    <script src="<?php echo e(asset_url('js/template-customizer.js')); ?>"></script>
    <script src="<?php echo e(asset_url('js/front-config.js')); ?>"></script>
</head>

<body>

    <script src=" <?php echo e(asset_url('js/dropdown-hover.js')); ?>"></script>
    <script src="<?php echo e(asset_url('js/mega-dropdown.js')); ?>"></script>
            ...
            <div class="navbar navbar-expand-xl landing-navbar">
                <div class="navbar-brand app-brand demo d-flex  me-4">
                    ...
                    <a href="#" class="app-brand-link">
                        <div class="logo-wrap">
                            <img src="<?php echo e(asset_url('img/header-logo.png')); ?>" alt="logo">
                        </div>
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto">
                                        ...
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link"
                                                    href="<?php echo e(route('guest-posting-services')); ?>">
                                                    <i class="ti ti-circle me-1"></i>
                                                    Guest Posting </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link"
                                                    href="<?php echo e(route('link-building-services')); ?>">
                                                    <i class="ti ti-circle me-1"></i>
                                                    Link Building
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link"
                                                    href="<?php echo e(route('content-writing-services')); ?>">
                                                    <i class="ti ti-circle me-1"></i>
                                                    Content Writing
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link"
                                                    href="<?php echo e(route('seo-reseller-services')); ?>">
                                                    <i class="ti ti-circle me-1"></i>
                                                    SEO Reseller
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link"
                                                    href="<?php echo e(route('content-marketing-services')); ?>">
                                                    <i class="ti ti-circle me-1"></i>
                                                    Content Marketing </a>
                                            </li>
                                        </ul>
                        ...
                        <li class="nav-item d-xl-none">
                            <a class="nav-link fw-medium" href="<?php echo e(route('login')); ?>">Login</a>
                        </li>
                        <li class="nav-item d-xl-none">
                            <a class="nav-link fw-medium" href="<?php echo e(route('register')); ?>">Sign Up for free</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="navbar-nav flex-row gap-2 align-items-center ms-auto d-none d-xl-flex">
                    <a href="<?php echo e(route('login')); ?>" class="outlined-btn">
                        Login
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="filled-btn">
                        Sign Up for free
                    </a>
                </div>
            </div>
    ...
    </script><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/pages/header.blade.php ENDPATH**/ ?>