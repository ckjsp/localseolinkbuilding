...
<aside id="layout-menu" class="layout-menu-horizontal menu-horizontal menu bg-menu-theme flex-grow-0">
    <div class="container-xxl d-flex">
        <ul class="menu-inner <?php echo e((isset($slug) && $slug == 'marketplace') ? 'my-2' : ''); ?>">
            <!-- Dashboards -->
            <li class="menu-item <?php echo e((!isset($slug) || $slug == '' || $slug == 'dashboard') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('advertiser')); ?>" class="menu-link">
            ...
            <li id="hover-dropdown-demo"
                class="menu-item <?php echo e((isset($slug) && $slug == 'projects') ? 'active' : ''); ?> dropdown">
            ...
            <!-- Market Place -->
            <li class="menu-item <?php echo e((isset($slug) && $slug == 'marketplace') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('advertiser.marketplace')); ?>" class="menu-link">
            ...
            <!-- My Order -->
            <li class="menu-item <?php echo e((isset($slug) && $slug == 'orders') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('advertiser.orders')); ?>" class="menu-link">
                    <i class="menu-icon tf-icons ti ti-briefcase"></i>
            ...
            <!-- Payment -->
            <li class="menu-item <?php echo e((isset($slug) && $slug == 'payment') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('advertiser.payment')); ?>" class="menu-link">
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#projects-menu .menu-link', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('advertiser.project.name')); ?>",
                method: 'GET',
                data: {
                    id: projectId
                },
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('advertiser.set.selected.project')); ?>",
                            method: 'POST',
                            data: {
                                _token: csrfToken,
        ...
        $(document).on('click', '.edit-btn-project', function() {
            var projectId = $(this).data('project-id');
            var editUrl = `<?php echo e(route('advertiser.projects.edit', ':id')); ?>`.replace(':id', projectId);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#project-form').attr('action', `<?php echo e(route('advertiser.projects.update', ':id')); ?>`.replace(':id', projectId));
        ...
        function resetProjectForm() {
            ...
            $('#add-projects-pop .modal-title').text('<?php echo e(__("Add Project Details")); ?>');
        }


        $(document).on('click', '.delete-btn', function() {
            var projectId = $(this).data('project-id');
            var deleteUrl = `<?php echo e(route('advertiser.delete', ':id')); ?>`.replace(':id', projectId);
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#addprojectBtn', function() {
            ...
            $('#project-form').attr('action', `<?php echo e(route('advertiser.projects.store')); ?>`);
        });
                                ...
                                <div class="card-body">
                                    <div class="row d-flex">
                                        ...
                                        <div class="col-md-6 d-flex align-items-center border rounded">
                                            <img src="<?php echo e(asset_url('img/pages/search-icon.png')); ?>"
...
<script src=" <?php echo e(asset_url('libs/toastr/toastr.js')); ?>"></script>
<script src="<?php echo e(asset_url('js/projects.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/advertiser/menu.blade.php ENDPATH**/ ?>