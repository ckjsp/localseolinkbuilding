...
<body>
    ...
    <div class="email-container">
        ...
        <ul>
            <li>
                <strong>Website Name:</strong> <?php echo e($websitename); ?>

            </li>

            <li><strong>Order ID:</strong> <?php echo e($customOrderId); ?></li>
            <li><strong>Payment Method:</strong> Razorpay</li>
            <li><strong>Type:</strong><?php echo e($attachment_type); ?></li>
...
</html><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/email/order_payment_successful_razorpay_publisher.blade.php ENDPATH**/ ?>