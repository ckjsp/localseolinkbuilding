    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
                ...
                <div class="container">
                    ...
                    <div id="heroDashboardAnimation" class="hero-animation-img">
                        <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
                            <img src="<?php echo e(asset_url('img/hero-element-img.png')); ?>" alt="hero dashboard"
                                class="animation-img"
                                data-app-light-img="<?php echo e(asset_url('img/hero-elements-img.png')); ?>"
                                data-app-dark-img="<?php echo e(asset_url('img/hero-elements-img.png')); ?>" />
                            <img src="<?php echo e(asset_url('img/hero-element-img.png')); ?>" alt="hero elements"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="client-logo-wrap">
                                ...
                                <img src="<?php echo e(asset_url('img/featured/chicago.png')); ?>" alt="client logo" />
                        ...
                        <div class="swiper-slide">
                            <div class="client-logo-wrap">
                                ...
                                <img src="<?php echo e(asset_url('img/featured/digital-gernal.png')); ?>" alt="client logo" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="client-logo-wrap">

                                <img src="<?php echo e(asset_url('img/featured/forbes.png')); ?>" alt="client logo" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="client-logo-wrap">

                                <img src="<?php echo e(asset_url('img/featured/hubspot.png')); ?>" alt="client logo" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="client-logo-wrap">

                                <img src="<?php echo e(asset_url('img/featured/mercury-news.png')); ?>" alt="client logo" />
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="client-logo-wrap">
                                <img src="<?php echo e(asset_url('img/featured/yahoo.png')); ?>" alt="client logo" />
                            </div>
        ...
        <section id="topFeatured" class="section-py topFeatured-section">
            <div class="container">
                ...
                <div class="img-wrap">
                    <img src="<?php echo e(asset_url('img/Featured Websites.png')); ?>" alt="top-featured-img">
                </div>
            </div>
        </section>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="card h-100 whyus-card">
                                        <div class="h-100">
                                            <div class="img-wrap">
                                                <img src="<?php echo e(asset_url('img/whyus/transparency.png')); ?>"
                                                    alt="whyus-img">
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card h-100 whyus-card">
                                        <div class="h-100">
                                            <div class="img-wrap">
                                                <img src="<?php echo e(asset_url('img/whyus/content.png')); ?>" alt="whyus-img">
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card h-100 whyus-card">
                                        <div class="h-100">
                                            <div class="img-wrap">
                                                <img src="<?php echo e(asset_url('img/whyus/backlinks.png')); ?>" alt="whyus-img">
                                            </div>
            ...
            <div class="container">
                ...
                <div class="registered-wrap">
                    <div class="row  align-items-center flex-column-reverse flex-md-row">
                        ...
                        <div class="col-md-6">
                            <div class="img-wrap">
                                <img src="<?php echo e(asset_url('img/registered-img.png')); ?>" alt="registered-img">
                            </div>
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/pages/home.blade.php ENDPATH**/ ?>