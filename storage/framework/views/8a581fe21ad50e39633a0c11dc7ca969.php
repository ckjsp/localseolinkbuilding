            ...
            <div class="row justify-content-between  gx-0 gy-4 g-md-5 ">
                <div class="col-lg-3">
                    <div class="mb-40">
                        <a href="#" class="footer-logo">
                            <img src="<?php echo e(asset_url('img/footer-logo.png')); ?>" alt="footer-logo">
                        </a>
                    </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6 col-6">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-3">
                            <a href="<?php echo e(route('guest-posting-services')); ?>" class="footer-link">Guest Posting</a>
                        </li>
                        <li class="mb-3">
                            <a href="<?php echo e(route('link-building-services')); ?>" class="footer-link">Link Building</a>
                        </li>
                        <li class="mb-3">
                            <a href="<?php echo e(route('content-writing-services')); ?>" class="footer-link">Content Writing</a>
                        </li>
                        <li class="mb-3">
                            <a href="<?php echo e(route('seo-reseller-services')); ?>" class="footer-link">SEO Reseller</a>
                        </li>
                        <li class="mb-3">
                            <a href="<?php echo e(route('content-marketing-services')); ?>" class="footer-link">Content Marketing</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 col-6">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-3">
                            <a href="<?php echo e(route('about-us')); ?>" class="footer-link">About</a>
                        </li>
                        <li class="mb-3">
                            <a href="<?php echo e(route('contact-us')); ?>" class="footer-link">Contact</a>
                        </li>
                        <li class="mb-3">
                            <a href="<?php echo e(route('blog')); ?>" class="footer-link">Blog</a>
                        </li>
...
</footer><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/pages/footer.blade.php ENDPATH**/ ?>