...
<body>
    <div data-bs-spy="scroll" class="scrollspy-example">
                        ...
                        <div class="row g-2 gy-md-5 ">
                            <div class="col-lg-2 col-md-4 col-sm-6 col-6">
                                <div class="posting_card">
                                    <h6>Improve search engine ranking</h6>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-4 col-sm-6 col-6">
                                <div class="posting_card">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6 col-6">
                                <div class="posting_card">
                                    <h6>Increased brand awareness</h6>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-4 col-sm-6 col-6">
                                <div class="posting_card">
            ...
            <div class="container">
                ...
                <div class="data_wrap">
                    <div class="d-flex flex-wrap justify-content-center gap-2 gap-md-3 ">
                        <div class="data_card">
                            <div class="icon_wrap">
                                <img src="<?php echo e(asset_url('img/transform-strategy/img_1.png')); ?>" alt="linksfarmer-img">
                            </div>
                            <h6>114,828+ high DA websites</h6>
                        </div>
                        <div class="data_card">
                            <div class="icon_wrap">
                                <img src="<?php echo e(asset_url('img/transform-strategy/img_2.png')); ?>" alt="linksfarmer-img">
                            </div>
                            <h6>Niche-specific placements</h6>
                        </div>
                        <div class="data_card">
                            <div class="icon_wrap">
                                <img src="<?php echo e(asset_url('img/transform-strategy/img_3.png')); ?>" alt="linksfarmer-img">
                            </div>
                            <h6>White-hat tactics, no PBNs</h6>
                        </div>
                        <div class="data_card">
                            <div class="icon_wrap">
                                <img src="<?php echo e(asset_url('img/transform-strategy/img_4.png')); ?>" alt="linksfarmer-img">
                            </div>
                            <h6>In-house content writers</h6>
                        </div>
                        <div class="data_card">
                            <div class="icon_wrap">
                                <img src="<?php echo e(asset_url('img/transform-strategy/img_5.png')); ?>" alt="linksfarmer-img">
                            </div>
                            <h6>100% do-follow content links</h6>
                        </div>
                        <div class="data_card">
                            <div class="icon_wrap">
                                <img src="<?php echo e(asset_url('img/transform-strategy/img_6.png')); ?>" alt="linksfarmer-img">
                            </div>
                            <h6>Fast 30-32 hour delivery</h6>
                        </div>
                        <div class="data_card">
                            <div class="icon_wrap">
                                <img src="<?php echo e(asset_url('img/transform-strategy/img_7.png')); ?>" alt="linksfarmer-img">
                            </div>
                            <h6>Buy guest posts from $2</h6>
                        </div>
                        <div class="data_card">
                            <div class="icon_wrap">
                                <img src="<?php echo e(asset_url('img/transform-strategy/img_8.png')); ?>" alt="linksfarmer-img">
                            </div>
                            <h6>Instant link replacement if needed</h6>
                        </div>
                        <div class="data_card">
                            <div class="icon_wrap">
                                <img src="<?php echo e(asset_url('img/transform-strategy/img_9.png')); ?>" alt="linksfarmer-img">
                            </div>
                            <h6>White-label guest blogging</h6>
                        </div>
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="right_wrap">
                            <ul>
                                <li>
                                    <p>
                                        At LINKSFARMER, you can spend valuable time to enhance your website rankings.
                                        There are
                                        no
                                        retainers, subscriptions, or any other hidden fees.
                                    </p>
                                </li>
                            </ul>
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="right_wrap">
                            <ul>
                                <li>
                                    <p>
                                        LINKSFARMER guaranteed backlinks via our world's biggest catalog with fixed
                                        prices. We are not like traditional outreach firms.
                                    </p>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="right_wrap">
                            <ul>
                                <li>
                                    <p>
                                        We donate a certain percentage of our revenue to pro-journalism and
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="right_wrap">
                            <ul>
                                <li>
                                    <p>
                                        Register On The Marketplace- When it’s free, register as an advertiser, create
                                        your profile and get instant access to LINKSFARMER guest blogging marketplace.
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        Compare and Choose Websites- Compare websites based on your needs, which include
                                        DA range, niche, traffic range, budget, and more. Simply choose among them.
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        Upload Your Content or Hire a Content Writer— When you have content already,
                                        upload it. If not, hire one of our top-notch content writers in the niche of
                                        your preference. It ensures high-quality deliverables.
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        Get a high-quality guest post—make the payment and get your post delivered to
                                        you within 30-32 hours.
                                    </p>
                                </li>
                            </ul>
                        </div>
        ...
        <section class="section-py  landing-reviews ">
            <div class="container">
                                        ...
                                        <div class="card h-100 reviews-card">
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                <div class="logo-wrap me-2 ">
                                                    <img src="<?php echo e(asset_url('img/google-logo.png')); ?>" />
                                                </div>
                                                <div>
        ...
        <section class="linear_bg_section">
            <div class="container">
            ...
            <div class="container">
                ...
                <ul class="custom_timeline timeline pb-0 mb-0">
                    <li class="timeline-item timeline-item-transparent ">
                        ...
                        <div class="right_wrap">
                            <h4>Strategic Register on the Marketplace (It's free)</h4>
                            <p>Strategic Register on the Marketplace (It's free)</p>
                        </div>
                    ...
                    <li class="timeline-item timeline-item-transparent ">
                        ...
                        <div class="right_wrap">
                            <h4>Compare & Choose Websites</h4>
                            <p>Compare 114,860+ websites based on your requirements, such as DA range, niche, traffic
                                range, budget, etc., and choose the right one.</p>
                        </div>
                    ...
                    <li class="timeline-item timeline-item-transparent ">
                        ...
                        <div class="right_wrap">
                            <h4>Upload your Content or Hire a Content Writer</h4>
                            <p>Upload your content if you have it ready. Or, hire one of our top-notch content writers
                                in the niche of your preference for high-quality deliverables (see samples).</p>
                        </div>
                    ...
                    <li class="timeline-item timeline-item-transparent  pb-0">
                        ...
                        <div class="right_wrap">
                            <h4>Get your High-Quality Guest Post</h4>
                            <p>Make the payment and get your post delivered to you within 30-32 hours.</p>
                        </div>
                ...
                <div class="data_wrap">
                    <div class="row g-3  ">
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="data_card">
                                <div class="icon_wrap">
                                    <img src="<?php echo e(asset_url('img/guest-posting/img_1.png')); ?>" alt="linksfarmer-img">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="data_card">
                                <div class="icon_wrap">
                                    <img src="<?php echo e(asset_url('img/guest-posting/img_2.png')); ?>" alt="linksfarmer-img">
                                </div>
                                <h6>Boost Domain Authority </h6>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="data_card">
                                <div class="icon_wrap">
                                    <img src="<?php echo e(asset_url('img/guest-posting/img_3.png')); ?>" alt="linksfarmer-img">
                                </div>
                                <h6>Drive High-Intent Traffic</h6>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="data_card">
                                <div class="icon_wrap">
                                    <img src="<?php echo e(asset_url('img/guest-posting/img_4.png')); ?>" alt="linksfarmer-img">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="data_card">
                                <div class="icon_wrap">
                                    <img src="<?php echo e(asset_url('img/guest-posting/img_5.png')); ?>" alt="linksfarmer-img">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="data_card">
                                <div class="icon_wrap">
                                    <img src="<?php echo e(asset_url('img/guest-posting/img_6.png')); ?>" alt="linksfarmer-img">
                                </div>
                ...
                <div class="data_wrap">
                    <div class="row g-2 g-lg-3">
                        <div class="col-lg-3 col-sm-6 col-6 ">
                            <a href="<?php echo e(route('content-writing-services')); ?>">

                                <div class="services-card">
                                    <div class="img-wrap">
                                        <img src="<?php echo e(asset_url('img/services/service1.png')); ?>" alt="service-img">
                                    </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-6 ">
                            <a href="<?php echo e(route('link-building-services')); ?>">


                                <div class="services-card">
                                    <div class="img-wrap">
                                        <img src="<?php echo e(asset_url('img/services/service2.png')); ?>" alt="service-img">
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <h6>Link Building</h6>
                                        <i class="ti ti-arrow-narrow-right "></i>
                        ...
                        <div class="col-lg-3 col-sm-6 col-6 ">
                            <a href="<?php echo e(route('content-marketing-services')); ?>">

                                <div class="services-card">
                                    <div class="img-wrap">
                                        <img src="<?php echo e(asset_url('img/services/service3.png')); ?>" alt="service-img">
                                    </div>
                                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-lg-3 col-sm-6 col-6 ">
                            <a href="<?php echo e(route('seo-reseller-services')); ?>">

                                <div class="services-card">
                                    <div class="img-wrap">
                                        <img src="<?php echo e(asset_url('img/services/service4.png')); ?>" alt="service-img">
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <h6>SEO Reseller</h6>
                                        <i class="ti ti-arrow-narrow-right "></i>
...
</html><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/pages/guestpostingservices.blade.php ENDPATH**/ ?>