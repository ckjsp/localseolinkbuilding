...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('sidebar-content'); ?> <?php echo $__env->make('advertiser.filter_second', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="table-responsive text-nowrap m-3">
                    ...
                    <table class="table" id="websitesTable">
                        ...
                        <tbody class="table-border-bottom-0">
                            <?php $__currentLoopData = $websites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php
                            if (
                            array_search(
                            $userDetail->id,
                            ...
                            <tr>
                                ...
                                <td><?php echo e($v->publishing_time); ?> Days</td>
                                <td>
                                    <?php echo e($v->maximum_no_of_backlinks_allowed); ?>

                                    <?php echo e(ucwords($v->backlink_type)); ?>

                                </td>
                                <td>$<?php echo e($v->guestpostprice_adminprice); ?></td>
                                <td>$<?php echo e($v->linkedinsession_adminprice); ?></td>
                                <td>
                                    <button type="button" class="btn <?php echo e($cls); ?> waves-effect waves-light" data-web_id="<?php echo e($v->id); ?>"
                                ...
                                <td>
                                    <button type="button" data-bs-toggle="collapse" data-bs-target="#website-<?php echo e($k); ?>"
                                        aria-controls="website-<?php echo e($k); ?>" aria-expanded="false"
                                ...
                                <td class="accordion-body" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-2 my-3">
                                            ...
                                            <?php echo e($v->minimum_word_count_required); ?>

                                        </div>
                                        <div class="col-md-2 my-3"><strong>Spam Score:</strong> <?php echo e($v->spam_score); ?>

                                        </div>
                                        <div class="col-md-3 my-3"><strong>Role:</strong> Guest Post</div>
                                        <div class="col-md-4 my-3"><strong>Link Insertion
                                                Price:</strong>$<?php echo e($v->link_insertion_price); ?></div>
                                        ...
                                        <div class="col-md-4 my-3">
                                            <button type="button" class="border-none badge bg-label-info me-1 p-2"
                                                data-bs-toggle="modal" data-bs-target="#guidelines-<?php echo e($k); ?>">
                                                Guidelines
                                            </button>
                                        </div>
                                        <div class="col-md-3 my-3">
                                            <a href="<?php echo e($v->sample_post_url); ?>">View Sample</a>
                                        </div>
                                    </div>
                                </td>
                                <div class="modal fade" id="guidelines-<?php echo e($k); ?>" tabindex="-1" style="display: none"
                                    aria-hidden="true">
    ...
    <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <p class="text-wrap">
                    <?php echo e(__("Are you sure you wan't to delete this record!")); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('advertiser.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/advertiser/marketplace.blade.php ENDPATH**/ ?>