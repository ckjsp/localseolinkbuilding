<div class="modal fade" id="edit-projects-pop" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="text-center mb-4">
                    <h3 class="modal-title mb-2"><?php echo e(__('Edit Project Detail')); ?></h3> <!-- Default title -->
                </div>
                <form method="POST" action="<?php echo e(route('advertiser.projects.store')); ?>" class="needs-validation"
...
<script src="<?php echo e(asset_url('js/projects.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\localseolinkbuilding\resources\views/advertiser/partials/createeditmodel.blade.php ENDPATH**/ ?>